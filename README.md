...
SQL is a query language where you can query rows and columns to manipulate data where as Relational databases is a way to store data in rows and columns like a spreadsheet

- [x] Why do tables need a `primary key`?

Primary Keys are use in tables to create a unique identifier
...
You will need to map out how many tables are needed, from there you will need to create at least 3 tables to get all the required information that you need.
